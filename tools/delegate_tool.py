...
def delegate_task(
    ...
    profile_resolved_toolsets: Optional[list[str]] = (
        list(toolsets) if resolved_profile_name else None
    )
    ...
    try:
        for i, t in enumerate(task_list):
            ...
            if (
                _task_profile_name
                and isinstance(_task_profile_name, str)
                and _task_profile_name.strip()
            ):
                try:
                    _task_pdata = _resolve_profile(
                        _task_profile_name, _load_agent_profiles()
                    )
                except ValueError:
                    pass
                else:
            ...
            child = _build_child_agent(
                ...
                toolsets=profile_resolved_toolsets
